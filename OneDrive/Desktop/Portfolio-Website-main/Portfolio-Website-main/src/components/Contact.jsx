      ...
      <div className="flex flex-col lg:max-w-[50%] grow bg-gray-50 p-8 md:p-12 rounded-l-xl">
        ...
        <div className="flex flex-col grow space-y-6">
          <div>
            ...
            <p className="text-lg font-medium">devangsh191@gmail.com</p>
          </div>
          <div className="space-y-4">
            ...
            <div className="flex flex-col space-y-3">
              <Socials
                Icon={ FaGithub }
                href="https://github.com/devang-shramaa"
                suffix="/ Devang"
              />
              <Socials
                Icon={ FaLinkedinIn }
                href="https://www.linkedin.com/in/devang-sharma-535315308/"
                suffix="/ Devang Sharma"
              />
            </div>
          </div>
